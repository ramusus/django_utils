...
class ForeignKeySearchInput(forms.HiddenInput):
    class Media:
        css = {
            'all': ('css/jquery_autocomplete.css',)
        }
        js = (
            'js/jquery_autocomplete/lib/jquery.js',
            'js/jquery_autocomplete/lib/jquery.bgiframe.min.js',
            'js/jquery_autocomplete/lib/jquery.ajaxQueue.js',
            'js/jquery_autocomplete/jquery.autocomplete.js'
        )
