...
jQuery(function($) {
    ...
    $('div.inline-group div.tabular').each(function() {
        ...
        $(this).find('fieldset').append('<a class="add" href="#">' + add_link_html + '</a>');
        ...
        $(this).find('a.add').click(function(){
            ...
            $(this).parent().find('table tr:last').find('.autocomplete').each(function() {
                ajaxSelectBindAutocomplete($(this).attr('rel'), this.id);
            });
